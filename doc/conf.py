# -*- coding: utf-8 -*-
#
# desistar documentation build configuration file, created by
...
latex_documents = [
  ('index', 'desistar.tex', u'desistar Documentation',
   u'DESI', 'manual'),
]
...
man_pages = [
    ('index', 'desistar', u'desistar Documentation',
     [u'DESI'], 1)
]
...
texinfo_documents = [
  ('index', 'desistar', u'desistar Documentation',
   u'DESI', 'desistar', 'One line description of project.',
   'Miscellaneous'),
]
